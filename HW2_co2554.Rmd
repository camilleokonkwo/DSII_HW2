...
```
The best fit GAM model does include all predictors. From the final models plots, we can see that some predictors are more non-linear than others. The test error is `r mean((pred.gam - y2)^2)`.
